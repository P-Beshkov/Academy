/*11. Implement a Gift class. It should be a moving object, 
 * which always falls down. The gift shouldn't collide with any ball, 
 * but should collide (and be destroyed) with the racket. 
