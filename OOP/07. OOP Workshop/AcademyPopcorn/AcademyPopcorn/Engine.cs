    ...
    public class Engine
    {
        ...
        public int GameSpeed
        {
            ...
            set
            {
                if (value>10 || value<1)
                {
                    throw new ArgumentOutOfRangeException("Game speed must be in range[1..10]");
                }
                this.gameSpeed = 1100 - value*100;
            }
            
        }
        public Engine(IRenderer renderer, IUserInterface userInterface) : this(renderer,userInterface,5)
        {            
        }
